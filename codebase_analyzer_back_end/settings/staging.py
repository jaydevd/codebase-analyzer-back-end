...
if not SECRET_KEY:
    raise ImproperlyConfigured("SECRET_KEY must be set when ENVIRONMENT=staging.")

ALLOWED_HOSTS = get_list_env("ALLOWED_HOSTS")
if not ALLOWED_HOSTS:
    raise ImproperlyConfigured("ALLOWED_HOSTS must be set when ENVIRONMENT=staging.")
